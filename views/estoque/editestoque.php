...
/*<!--Cliente list PHP -->
  <div class="row">
    <form id="form" action="editcompra.php" method="post">
      <div class="box-body">
  ...
  <!-- form start -->
  <form role="form" action="../../App/Database/insertEstoque.php" method="POST">
    <div class="box-body">

      <div class="form-group row"> <!--Primeiro Div-->
        <div class="col-sm-2">
          <label for="exampleInputEmail1">SKU</label>
          <input type="text" name="skuProduto" class="form-control" id="exampleInputEmail1" placeholder="sku" value="<?php echo $resp['compras']['SKU']; ?>">
        </div>

        <div class="col-sm-2">
          <label for="exampleInputEmail1">Modelo</label>
          <input type="text" name="model" class="form-control" id="exampleInputEmail1" placeholder="Modelo" value="<?php echo $resp['compras']['Modelo']; ?>">
        </div>

        <div class="col-sm-7">
          <label for="exampleInputEmail1">Nome do Produto</label>
          <input type="text" name="NomeProduto" class="form-control" id="exampleInputEmail1" placeholder="Nome do Produto" value="<?php echo $resp['compras']['Nome']; ?>">
        </div>
      </div>
      ...
      <div class="form-group row"><!--Segunda Div-->
        <div class="col-sm-2">
          ...
          <input type="text" name="CodRastreio" class="form-control" id="exampleInputEmail1" placeholder="Cod. de Rastreio" value="<?php echo $resp['compras']['Rastreio']; ?>">
        </div>
        ...
        <div class="col-sm-2">
          ...
          <div class="input-group">
            ...
            <input type="number" name="ValorCompra" class="form-control" id="exampleInputEmail1" placeholder="Valor da Compra" step="0.01" min="0" value="<?php echo $resp['compras']['Valor']; ?>">
          </div>
        </div>
        ...
        <div class="col-sm-3">
          ...
          ?>
          <input type="datetime-local" name="DataCompra" class="form-control" id="exampleInputEmail1" placeholder="MM/DD/YYYY" value="<?php echo $dataCompra; ?>">
        </div>
        ...
        <div class="col-sm-3">
          ...
          <?php
          $DataEntrega = '';
          if (!empty($resp['compras']['Entrega'])) {
            // converte a data do banco de dados para o formato ISO 8601
            $DataEntrega = date('Y-m-d\TH:i', strtotime($resp['compras']['Entrega']));
          }
          ?>
          <input type="datetime-local" name="DataEntrega" class="form-control" id="exampleInputEmail1" placeholder="MM/DD/YYYY" value="<?php echo $DataEntrega; ?>">
        </div>

        <div class="col-sm-1">
          <label for="exampleInputEmail1">Estoque</label>
          <input type="text" name="QuantItens" class="form-control" id="exampleInputEmail1" placeholder="Quant." value="<?php echo $resp['compras']['Saldo']; ?>">
        </div>
    ...
    echo '
              ...
              <div class="box-footer">
                ...
                <a class="btn btn-danger" href="../../views/estoque">Cancelar</a>
              </div>
          </form>
             </div>
